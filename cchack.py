...
║   Credit: UMMAH BLACK HAT              ║
╚═══════════════════════════════════════╝
"""
    print(f"{Fore.RED}{banner}{Style.RESET_ALL}")
    print(f"{Fore.GREEN}[*] Developed by: {Fore.YELLOW}UMMAH BLACK HAT{Style.RESET_ALL}")
    print(f"{Fore.GREEN}[*] GitHub: {Fore.YELLOW}github.com/gtaminul-cmyk{Style.RESET_ALL}")
